...
de uma única senha. Hoje tem três empresas com página fixa, mais duas
páginas para criar e gerenciar empresas novas direto pelo app:
...
Requer Python 3.10+ e o pacote de sistema `poppler-utils` (fornece o
`pdftotext`, usado para ler o PDF da APAE).
...
├── requirements.txt
├── packages.txt                    # poppler-utils (leitura do PDF da APAE)
